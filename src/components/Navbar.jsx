      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        >
          ...
          <span className="relative text-black group-hover:text-white flex items-center gap-x-3">
            <a href="https://drive.google.com/file/d/1HmRm8iqA8Q7nWt3RNI5qpcTvPlDw_TCe/view?usp=sharing" target="_blank" className="relative text-black group-hover:text-white flex items-center gap-x-3">Resume</a> <TbDownload size={16} />
          </span>
        </motion.a>
